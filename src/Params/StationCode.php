...
final class StationCode
{
    private const STATIONS = [
        ...
        'CPN' => 'Chapelton (Devon)',
        'CLN' => 'Chapeltown (South Yorkshire)',
        ...
        'NFL' => 'Northfleet',
        'NLT' => 'Northolt Park',
        'NOP' => 'Northumberland Park (Tyne & Wear)',
    ...
    {
        return self::STATIONS[$this->code];
    }
    ...
    public static function random(): StationCode
    {
        return new StationCode(array_rand(self::STATIONS));
    }
